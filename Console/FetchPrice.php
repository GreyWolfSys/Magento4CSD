...
namespace Altitude\CSD\Console;
...
class FetchPrice extends Command
{
    ...
    {
        $this->setName('CSDPricing:fetchPrice');
    ...
    public function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->csd->gwLog(__CLASS__ . "/" . __FUNCTION__ . ": ", "Console FetchPrice is executing.");
        ...
        if (!empty ($listorbase)) {
            ...
            foreach ($productCollection as $product) {
                ...
                try {
                    ...
                    $this->csd->gwLog(__CLASS__ . "/" . __FUNCTION__ . ": ", "ERROR!!!" . $e1->getMessage());
                }
            }
        }
        try {
        ...
        $this->csd->gwLog(__CLASS__ . "/" . __FUNCTION__ . ": ", "Console FetchPrice is complete.");
